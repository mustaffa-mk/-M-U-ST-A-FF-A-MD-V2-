...
cmd({
    ...
    try {
        if (!q) return reply("📂 *𒋲⍟ᬼ⃟M💀⃝⃪U⛓ST۞༒A༒ FF⛓⍟ᬼ⃟A𒋲, please provide an app name! (e.g., .apk WhatsApp)*");
        ...
        const fancyCaption = `
╔═══════════════════╗
     📂  *𒋲⍟ᬼ⃟M💀⃝⃪U⛓ST۞༒A༒ FF⛓⍟ᬼ⃟A𒋲⍟ᬼ⃟MD💀⃝⃪V2🕷️™ 𝐀𝐏𝐊* 📂
╚═══════════════════╝
...
`.trim();
        ...
        await sendButtons(conn, from, {
            ...
            text: fancyCaption,
            footer: botFooter || '𒋲⍟ᬼ⃟M💀⃝⃪U⛓ST۞༒A༒ FF⛓⍟ᬼ⃟A𒋲 ᴀɪ ᴋᴇɴʏᴀ 🌠',
